...
from diffusion_policy.policy.diffusion_transformer_hybrid_image_policy_012 import DiffusionTransformerHybridImagePolicy
    ...
    def run(self):
        ...
        with JsonLogger(log_path) as json_logger:
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                # run rollout only if env_runner exists
